...
BEGIN
	...
	IF(DEC_VACIO = 0 ) THEN
	  ...
	  VALUES (VAR_CEDULA, VAR_NOMBRE, VAR_ROL, VAR_CLAVE, VAR_PREGUNTA, VAR_RESPUESTA, VAR_USUARIO_ACTIVADO, VAR_USUARIO_VERIFICADO, NOW(), NOW(), VAR_CONTACTO);
	 	SELECT CEDULA FROM USUARIO WHERE CEDULA = VAR_CEDULA;
	ELSE
...
BEGIN
	...
	ELSE
		SELECT CONCAT("USUARIO ", VAR_CEDULA, " NO SE PUDO MODIFICAR") AS "RESULTADO";
	END IF;
END $$
DELIMITER ;
...
BEGIN
	...
	IF(DEC_VACIO != 0) THEN
		UPDATE USUARIO
		SET NOMBRE = VAR_NOMBRE, CLAVE = VAR_CLAVE, PREGUNTA = VAR_PREGUNTA, RESPUESTA = VAR_RESPUESTA, CONTACTO = VAR_CONTACTO
		WHERE CEDULA = VAR_CEDULA;
		SELECT CONCAT("USUARIO ", VAR_CEDULA, " MODIFICADO") AS "RESULTADO";
	ELSE
		SELECT CONCAT("USUARIO ", VAR_CEDULA, " NO SE PUDO MODIFICAR") AS "RESULTADO";
...
BEGIN
	...
	ELSE
		SELECT CONCAT("USUARIO ", VAR_CEDULA, " NO SE PUDO LOGUEAR") AS "RESULTADO";
	END IF;
END $$
DELIMITER ;